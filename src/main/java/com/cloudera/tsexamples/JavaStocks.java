...
public class JavaStocks {
    private static Dataset<Row> loadObservations(JavaSparkContext sparkContext, SQLContext sqlContext,
        ...
        JavaRDD<Row> rowRdd = sparkContext.textFile(path).map((String line) -> {
            ...
            ZonedDateTime dt = ZonedDateTime.of(
                    Integer.parseInt(tokens[0]), Integer.parseInt(tokens[1]), Integer.parseInt(tokens[1]),
                    0, 0, 0, 0,
    ...
    public static void main(String[] args) {
        ...
        // Cache it in memory
        tickerTsrdd.cache();
        System.out.println(tickerTsrdd.toString());
        ...
        JavaPairRDD<String, Double> dwStats = returnRates.mapValues(TimeSeriesStatisticalTests::dwtest);
